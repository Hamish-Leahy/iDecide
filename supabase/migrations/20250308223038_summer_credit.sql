...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "Users can manage versions of their documents" ON document_versions;
...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "Users can manage metadata of their documents" ON document_metadata;
...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "Users can view access records for their documents" ON document_access;
